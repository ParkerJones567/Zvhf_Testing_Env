...
set(RISCV_LLVM_PREFIX "${CMAKE_CURRENT_SOURCE_DIR}/../Toolchain/llvm/llvm/bin" CACHE PATH "Install location of LLVM RISC-V toolchain.")

set(CMAKE_C_COMPILER ${RISCV_LLVM_PREFIX}/clang-17)
set(CMAKE_CXX_COMPILER ${RISCV_LLVM_PREFIX}/clang-17)
set(CMAKE_ASM_COMPILER ${RISCV_LLVM_PREFIX}/clang-17)
set(CMAKE_OBJCOPY ${RISCV_LLVM_PREFIX}/llvm-objcopy-17)
set(CMAKE_OBJDUMP ${RISCV_LLVM_PREFIX}/llvm-objdump-17)
