...
execute_process(COMMAND ${SPIKE_DIR}/spike --isa=rv32imfv_zicntr_zihpm_zfh --varch=vlen:1024,elen:64 +signature=${BUILD_DIR}/${TEST_NAME}_Spike_reference.txt --signature=${BUILD_DIR}/${TEST_NAME}_Spike_reference.txt +signature-granularity=4 --signature-granularity=4 ${BUILD_DIR}/${TEST_NAME}_Spike.elf  
