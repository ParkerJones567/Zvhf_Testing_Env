...
execute_process(COMMAND ${SPIKE_DIR}/spike --isa=rv32imf_zicntr_zihpm_zfh_zve32f_zvfh_zvl${VLEN}b +signature=${BUILD_DIR}/${TEST_NAME}_Spike_reference.txt --signature=${BUILD_DIR}/${TEST_NAME}_Spike_reference.txt +signature-granularity=4 --signature-granularity=4 ${BUILD_DIR}/${TEST_NAME}_Spike.elf  
