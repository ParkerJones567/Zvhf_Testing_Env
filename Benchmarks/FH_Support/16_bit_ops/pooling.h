        ...
        for (int channel = 0; channel < depth; ++channel) {
          ...
          for (int filter_y = filter_y_start; filter_y < filter_y_end;
            ...
            for (int filter_x = filter_x_start; filter_x < filter_x_end;
              ...
              total +=
                  input_fp16[Offset(input_shape, batch, in_y, in_x, channel)];
              filter_count++;
            }
          }
          if (filter_count == 0) return false;
          const _Float16 average = total / filter_count;
          output_fp16[Offset(output_shape, batch, out_y, out_x, channel)] =
              ActivationFunctionWithMinMax(average, (_Float16)params.float_activation_min,
                                           (_Float16)params.float_activation_max);
        }
      }
    }
  }
